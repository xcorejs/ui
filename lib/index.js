...
var defaultsScalePair = function defaultsScalePair(t, s) {
  return Object.keys(s).reduce(function (acc, k) {
    ...
    return _objectSpread({}, acc, _defineProperty({}, k, _typeof(acc[k]) === 'object' && !Array.isArray(t) ? _objectSpread({}, s[k], {}, acc[k]) : (_acc$k = acc[k]) !== null && _acc$k !== void 0 ? _acc$k : s[k]));
  }, t);
};
...
var mergeThemePair = function mergeThemePair(target, source) {
  var next = _objectSpread$1({}, target, {
...
var createScales = function createScales() {
  ...
  return _objectSpread$2({}, colors(), {}, breakpoints(), {}, fonts(), {}, scale);
};
...
var createTheme = function createTheme() {
  ...
  return _objectSpread$3((_objectSpread2 = {}, _defineProperty(_objectSpread2, '__xcoreTheme', true), _defineProperty(_objectSpread2, "name", 'Xcore'), _objectSpread2), global(), {}, container(), {}, text(), {}, button(), {}, typography(), {}, link(), {}, tag(), {}, card(), {}, list(), {}, createScales(), {}, closeControl(), {}, modal(), {}, theme);
};
...
var polyfillTheme = function polyfillTheme(p) {
  ...
  return _objectSpread$4({}, p, {
    theme: p.theme === undefined || Object.keys(p.theme).length === 0 ? theme : p.theme
  });
};
var compose = function compose() {
  ...
  return function (p) {
    return styled.css(_templateObject(), flattenBases.map(function (b) {
...
var boxSystem = core.system(_objectSpread$5({}, layoutConfig, {}, spaceConfig, {}, typographyConfig, {}, visualsConfig, {}, borderConfig, {}, flexConfig, {}, gridItemConfig, {}, positionConfig, {}, cursorConfig, {}, shadowConfig, {
  animation: true,
  transition: true,
  transform: true,
  filter: true,
...
var selectionBase = function selectionBase(p) {
  return styled.css(_templateObject$1(), selectionSystem(p));
};
var boxBase = function boxBase(p) {
  return styled.css(_templateObject2(), boxSystem(p), p._icon && styled.css(_templateObject3(), pseudoBoxBaseComposed(_objectSpread$6({}, p._icon, {
    theme: p.theme
  })), core.system({
    fill: {
      property: 'fill',
  ...
  })(_objectSpread$6({}, p._icon, {
    theme: p.theme
  }))), p._selection && styled.css(_templateObject4(), selectionBase(_objectSpread$6({}, p._selection, {
    theme: p.theme
  }))), Object.keys(pseudoSelectors).map(function (k) {
    return p[k] && styled.css(_templateObject5(), pseudoSelectors[k], pseudoBoxBaseComposed(_objectSpread$6({}, p[k], {
      theme: p.theme
    })));
  }), p._group && Object.keys(groupPseudoSelectors).map(function (k) {
    return p._group[k] && styled.css(_templateObject6(), groupPseudoSelectors[k], pseudoBoxBaseComposed(_objectSpread$6({}, p._group[k], {
      theme: p.theme
    })));
  }));
};
...
var iconBase = base([flexBase], function (p) {
  return styled.css(_templateObject10(), core.system({
    fill: {
      property: 'fill',
      scale: 'colors',
      transform: colorTransform
...
var Box = styled__default.div(_templateObject$2(), compose(boxBase));
...
var Text = React.forwardRef(function (_ref, ref) {
  ...
  return React__default.createElement(TextStyle, Object.assign({}, props, {
    as: as,
    ref: ref
  }));
});
var TextStyle = styled__default.span(_templateObject$3(), composedTextBase);
...
var ActiveBreakpoint = function ActiveBreakpoint(props) {
  ...
  return React__default.createElement(Box, Object.assign({}, props), React__default.createElement(Text, null, React__default.createElement(Box, {
...
var Flex = styled__default.div(_templateObject$4(), composedFlexBase);
...
var AspectRatioStyle = styled__default.div(_templateObject$5(), composedBoxBase);
...
var AspectRatio = function AspectRatio(_ref) {
  ...
  return React__default.createElement(AspectRatioStyle, Object.assign({
    width: "100%",
    height: 0,
    pb: ratio * 100 + '%',
    position: "relative"
  }, props), React__default.createElement(Flex, {
    position: "absolute",
    alignItems: "center",
...
var Icon = function Icon(_ref) {
  ...
  return React__default.createElement(IconStyle, Object.assign({
    display: "inline-block",
    verticalAlign: "middle",
    maxHeight: "100%"
  }, props), renderComponent(svg), children);
};
var IconStyle = styled__default.span(_templateObject$6(), composedIconBase);
...
var Img = function Img(_ref) {
  ...
  return React__default.createElement(ImgStyle, Object.assign({}, props));
};
var ImgStyle = styled__default.img(_templateObject$7(), composedBoxBase, core.system({
  objectFit: true
}));
...
var LoremIpsum = React.forwardRef(function (_ref, ref) {
...
var mediaQueries = function mediaQueries(breakpoints, predicate) {
  return breakpoints.map(function (br, i) {
    var val = predicate(i, br);
    return isValueEmpty(val) ? styled.css(_templateObject$8()) : i === 0 ? val : styled.css(_templateObject2$1(), breakpoints[i - 1], val);
  });
};
  ...
  return {
    map: function map(unit) {
      return Object.keys(val).reduce(function (acc, k) {
        ...
        return v !== null && v !== undefined ? _objectSpread$7({}, acc, _defineProperty({}, k, v)) : acc;
      }, {});
    },
    mapAll: null,
    reduce: null,
...
var Grid = function Grid(_ref) {
  ...
  }, React__default.createElement(GridStyle, Object.assign({
    columns: t(columns),
    rows: t(rows),
    gap: t(gap),
...
var GridStyle = styled__default.div(_templateObject$9(), composedBoxBase, function (p) {
  return core.system(_objectSpread$8({}, gridConfig, {
    justifyItems: true,
    justifyContent: true,
    alignContent: true,
    alignItems: true,
  ...
  }))(polyfillTheme(_objectSpread$8({}, p, {
    rows: p.rows.value,
...
var Spinner = function Spinner(props) {
  return React__default.createElement(SpinnerStyle, Object.assign({
    display: "inline-block",
...
var spin = styled.keyframes(_templateObject$a());
var SpinnerStyle = styled__default.div(_templateObject2$3(), composedBoxBase, spin, function (_ref) {
...
var Stack = function Stack(_ref) {
  ...
  return React__default.createElement(Flex, Object.assign({
    ...
    return wrapItems ? React__default.createElement(Box, Object.assign({}, getStyle(i)), child) : React.isValidElement(child) ? React.cloneElement(child, getStyle(i)) : child;
  }));
};
...
var Cell = function Cell(_ref) {
  ...
  return React__default.createElement(CellStyle, Object.assign({
...
var CellStyle = styled__default.div(_templateObject$b(), composedBoxBase, function (p) {
  ...
  })(polyfillTheme(p)), // Manually position element in grid and handle place-self property
  mediaQueries(p.breakpoints, function (i) {
    ...
    (!column.empty(i) || !gap.empty(i)) && colStart && styled.css(_templateObject2$4(), colStart), (!column.empty(i) || !gap.empty(i)) && colEnd && styled.css(_templateObject3$2(), colEnd), (!row.empty(i) || !gap.empty(i)) && rowStart && styled.css(_templateObject4$2(), rowStart), (!row.empty(i) || !gap.empty(i)) && rowEnd && styled.css(_templateObject5$2(), rowEnd), // place-self
...
var InsetBox = function InsetBox(_ref) {
  ...
  return React__default.createElement(Portal, null, target ? React__default.createElement(Box, {
    position: "absolute",
    left: rect.x,
    top: rect.y,
    width: rect.width,
    ...
    width: "100%",
    height: "100%"
  }, React__default.createElement(InnerInsetBox, Object.assign({}, p)))) : React__default.createElement(InnerInsetBox, Object.assign({}, p)));
};
...
var OutsetBox = function OutsetBox(_ref) {
  ...
  return React__default.createElement(Portal, null, React__default.createElement(Box, {
    position: "absolute",
...
var Complement = function Complement(_ref3) {
  ...
  return React__default.createElement(React__default.Fragment, null, renderComponent(element), icon && React__default.createElement(Icon, Object.assign({
    mr: "1rem",
    svg: icon
  }, _icon)));
};
...
var Button = React.forwardRef(function (_ref, ref) {
  ...
  return React__default.createElement(ButtonStyle, Object.assign({
    role: "group",
    as: as
  }, props, {
    ref: ref
  }), React__default.createElement(Complement, Object.assign({}, left)), loading && React__default.createElement(Spinner, Object.assign({
    mr: children ? '1rem' : 0
  }, _spinner)), children, React__default.createElement(Complement, Object.assign({}, right)));
});
var ButtonStyle = styled__default.div(_templateObject$c(), compose(textBase, flexBase));
...
var Tag = function Tag(_ref) {
  ...
  return React__default.createElement(TagStyle, Object.assign({
    whiteSpace: "nowrap",
    alignItems: 'center',
    userSelect: 'none',
    transition: 'color 300ms, background 300ms, border-color 300ms'
  }, props), React__default.createElement(Complement, Object.assign({}, left)), children, React__default.createElement(Complement, Object.assign({}, right)));
};
var TagStyle = styled__default.div(_templateObject$d(), compose(flexBase, textBase));
...
var Card = React.forwardRef(function (_ref, ref) {
  ...
  return React__default.createElement(Flex, Object.assign({
    ...
    ref: ref
  }), (header || title) && React__default.createElement(Flex, null, React__default.createElement(Flex, Object.assign({
    order: 1
  }, _header, {
    ...
    flexGrow: 1
  }, header ? renderComponent(header) : React__default.createElement(Text, Object.assign({
    fontSize: '2rem',
    lineHeight: '3rem'
  }, _title), renderComponent(title))))), tag && React__default.createElement(Tag, Object.assign({
    position: "absolute",
    top: "0",
    right: "0",
    alignSelf: "center",
    m: (_header$p = _header.p) !== null && _header$p !== void 0 ? _header$p : _header.padding
  }, _tag), renderComponent(tag)), media && React__default.createElement(Flex, Object.assign({
    order: 2
  }, _media), renderComponent(media)), body && React__default.createElement(Flex, Object.assign({
    order: 3
  }, _body, {
    padding: getPadding(function (x) {
      return x._body;
    })
  }), renderComponent(body)), children && React__default.createElement(Flex, Object.assign({
    order: 3
  }, _body, {
    padding: getPadding(function (x) {
      return x._body;
    })
  }), children), footer && React__default.createElement(Flex, Object.assign({
    order: 4
  }, _footer, {
...
var CloseControl = React.forwardRef(function (p, ref) {
  var _useTheme = useTheme(),
  ...
  return React__default.createElement(CloseButtonStyle, Object.assign({
    display: "inline-flex",
    justifyContent: "center",
    alignItems: "center"
  }, props, {
    ...
    svg: React__default.createElement(CloseIcon, null)
  }, _icon)));
});
var CloseButtonStyle = styled__default.div(_templateObject$e(), composedFlexBase);

var Container = React.forwardRef(function (p, ref) {
  var _useTheme = useTheme(),
...
var Link = React.forwardRef(function (p, ref) {
  var _useTheme = useTheme(),
      link = _useTheme.link;

  var props = useMerge(p, typeVariant(link, 'simple', p), link.default);
  return React__default.createElement(LinkStyle, Object.assign({}, props, {
    ref: ref
  }));
});
var LinkStyle = styled__default.a(_templateObject$f(), composedTextBase);
...
var List = function List(p) {
  ...
  return React__default.createElement(ListStyle, Object.assign({
    as: type === 'unordered' ? 'ul' : 'ol'
  }, props));
};

List.displayName = 'List';
var ListStyle = styled__default.ul(_templateObject$g(), composedTextBase, function (p) {
  return core.system({
    paddingLeft: true,
    marginBottom: true,
    color: true,
...
var ListItem = function ListItem(p) {
  ...
  return React__default.createElement(ListItemStyle, Object.assign({
    alignItems: "flex-start"
  }, props), React__default.createElement(Complement, Object.assign({}, comp)), React__default.createElement("span", null, children));
};

var ListItemStyle = styled__default.li(_templateObject$h(), compose(flexBase, textBase));
...
var Typography = function Typography(_ref) {
  ...
  return React__default.createElement(TypographyStyle, Object.assign({}, props, {
    as: as
  }));
};
var TypographyStyle = styled__default.p(_templateObject$i(), composedTextBase);
...
var Modal = function Modal(_ref) {
  ...
  return React__default.createElement(InsetBox, Object.assign({
    ...
    justifyContent: "center",
    zIndex: 3
  }, _overlay), React__default.createElement(Flex, Object.assign({
    flexDirection: "column",
    position: "relative"
  }, props), React__default.createElement(Box, {
    onClick: onClose !== null && onClose !== void 0 ? onClose : function () {
      return setModal(undefined);
    }
  }, React__default.createElement(CloseControl, Object.assign({}, _close))), (header || title) && React__default.createElement(Flex, Object.assign({
    mb: "2rem"
  }, _header), header ? renderComponent(header) : React__default.createElement(Typography, Object.assign({
    v: "h3",
    as: "div"
...
var ModalProvider = function ModalProvider(_ref) {
  ...
  }, children, modal && React.createElement(modal, {
...
var XcoreGlobal = function XcoreGlobal() {
  ...
  return React__default.createElement(GlobalStyle, Object.assign({}, global));
};
var base$1 = compose(globalBase);
var GlobalStyle = styled.createGlobalStyle(_templateObject$j(), function (p) {
  return base$1(_objectSpread$9({}, p._html, {
    theme: p.theme
  }));
}, function (p) {
  return base$1(_objectSpread$9({}, p._body, {
    theme: p.theme
  }));
}, function (p) {
  return base$1(_objectSpread$9({}, p._all, {
    theme: p.theme
  }));
}, function (p) {
  return selectionBase(_objectSpread$9({}, p._selection, {
    theme: p.theme
  }));
}, function (p) {
  return selectionBase(_objectSpread$9({}, p._selection, {
...
var XcoreProvider = function XcoreProvider(_ref) {
  ...
  return theme !== null ? React__default.createElement(styled.ThemeProvider, {
    theme: theme !== null && theme !== void 0 ? theme : emptyTheme
  }, !disableGlobalStyles && React__default.createElement(XcoreGlobal, null), React__default.createElement(ModalProvider, null, children)) : React__default.createElement(ModalProvider, null, children);
};
