...
var defaultsScalePair = function defaultsScalePair(t, s) {
  return Object.keys(s).reduce(function (acc, k) {
    ...
    return _objectSpread$1({}, acc, _defineProperty({}, k, _typeof(acc[k]) === 'object' && !Array.isArray(t) ? _objectSpread$1({}, s[k], {}, acc[k]) : (_acc$k = acc[k]) !== null && _acc$k !== void 0 ? _acc$k : s[k]));
  }, t);
};
...
var polyfillTheme = function polyfillTheme(p) {
  ...
  return p && (!('theme' in p) || p.theme === undefined || Object.keys(p.theme).length === 0 ? _objectSpread$4({}, p, {
    theme: theme
  }) : p);
};
...
var boxBase = function boxBase(p) {
  return styled.css(_templateObject2(), boxSystem(p), p._icon && styled.css(_templateObject3(), pseudoBoxBaseComposed(_objectSpread$6({}, p._icon, {
    theme: p.theme
  })), pathSystem(_objectSpread$6({}, p._icon, {
    theme: p.theme
...
var Box = styled__default.div(_templateObject$1(), compose(boxBase));
...
var TextStyle = styled__default.span(_templateObject$2(), composedTextBase);
...
var Flex = styled__default.div(_templateObject$3(), composedFlexBase);
...
var AspectRatioStyle = styled__default.div(_templateObject$4(), composedBoxBase);
...
var IconStyle = styled__default.span(_templateObject$5(), composedIconBase);
...
var ImgStyle = styled__default.img(_templateObject$6(), composedBoxBase, imgSystem);
...
var GridStyle = styled__default.div(_templateObject$8(), composedBoxBase, function (p) {
  return gridSystem(polyfillTheme(_objectSpread$8({}, p, {
    rows: p.rows.value,
...
var SpinnerStyle = styled__default.div(_templateObject2$2(), composedBoxBase, spin, function (_ref) {
...
var CellStyle = styled__default.div(_templateObject$a(), composedBoxBase, function (p) {
...
var ButtonStyle = styled__default.div(_templateObject$b(), compose(textBase, flexBase));
...
var TagStyle = styled__default.div(_templateObject$c(), compose(flexBase, textBase));
...
var CloseButtonStyle = styled__default.div(_templateObject$d(), composedFlexBase);
...
var LinkStyle = styled__default.a(_templateObject$e(), composedTextBase);
...
var ListStyle = styled__default.ul(_templateObject$f(), composedTextBase, function (p) {
...
var ListItemStyle = styled__default.li(_templateObject$g(), compose(flexBase, textBase));
...
var TypographyStyle = styled__default.p(_templateObject$h(), composedTextBase);
...
var ModalInstanceContext = React.createContext({
  active: false
});
...
var ModalProvider = function ModalProvider(_ref) {
  ...
  return React__default.createElement(ModalContext.Provider, {
    ...
    return React__default.createElement(ModalInstanceContext.Provider, {
      key: i,
      value: {
        active: i === position
      }
