...
import React, { useContext, useMemo, forwardRef, createElement, createContext, Children, isValidElement, cloneElement, useState, useLayoutEffect, useEffect, useRef } from 'react';
...
var Img = function Img(_ref) {
  ...
  return /*#__PURE__*/React.createElement(ImgStyle, Object.assign({
    as: 'img'
  }, props));
};
...
var ImgStyle = styled.div.withConfig({
  shouldForwardProp: shouldForwardProp
...
var LoremIpsum = /*#__PURE__*/forwardRef(function (_ref, ref) {
...
var Stack = function Stack(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Flex, Object.assign({
    ...
    return wrapItems ? /*#__PURE__*/React.createElement(Box, Object.assign({}, getStyle(i)), child) : /*#__PURE__*/isValidElement(child) ? /*#__PURE__*/cloneElement(child, getStyle(i)) : child;
  }));
};
...
var Complement = function Complement(_ref3) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, renderComponent(element), icon && /*#__PURE__*/React.createElement(Icon, Object.assign({
    mr: "1rem",
    svg: icon
  }, _icon)));
};
...
var CloseControl = /*#__PURE__*/forwardRef(function (p, ref) {
  var _useTheme = useTheme(),
...
var Container = /*#__PURE__*/forwardRef(function (p, ref) {
  var _useTheme = useTheme(),
...
var Link = /*#__PURE__*/forwardRef(function (p, ref) {
  var _useTheme = useTheme(),
      link = _useTheme.link;
...
var List = /*#__PURE__*/forwardRef(function (p, ref) {
  var _ref, _p$v;
...
var useModal = function useModal(modal, defaultProps) {
  var history = useContext(ModalContext);
...
var ModalInstanceContext = /*#__PURE__*/createContext({
  hide: false
});
...
var Modal = function Modal(_ref) {
  var children = _ref.children,
      ...
      p = _objectWithoutProperties(_ref, ["children", "onClose", "persistent"]);
  ...
  useEffect(function () {
    var onEscape = function onEscape(e) {
      e.key === 'Escape' && (onClose !== null && onClose !== void 0 ? onClose : pop)();
    };
  ...
  return /*#__PURE__*/React.createElement(InsetBox, {
    ...
    onClick: function onClick(e) {
      var _overlay$onClick;

      !persistent && !ref.current.contains(e.target) && (onClose !== null && onClose !== void 0 ? onClose : pop)();
      _overlay === null || _overlay === void 0 ? void 0 : (_overlay$onClick = _overlay.onClick) === null || _overlay$onClick === void 0 ? void 0 : _overlay$onClick.call(_overlay, e);
    }
...
var ModalProvider = function ModalProvider(_ref) {
  ...
  return /*#__PURE__*/React.createElement(ModalContext.Provider, {
    ...
    return /*#__PURE__*/React.createElement(ModalInstanceContext.Provider, {
      key: i,
      value: {
        hide: i !== position
      }
...
var makeAlias = function makeAlias(v) {
  return /*#__PURE__*/forwardRef(function (p, ref) {
