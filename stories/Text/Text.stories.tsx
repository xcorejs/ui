      ...
      <Box>
        <Text>
          <Box>
            ...
            The last thing you'd want in your Burger King burger is someone's foot fungus. But as it turns out, that
            might be what you get. A
            <Text t="strikethrough">
              4channer
            </Text>
            uploaded a photo anonymously to the site showcasing his feet in a plastic bin of lettuce. With the
            statement: <Text t="em">"This is the lettuce you eat at Burger King." </Text>
            Admittedly, he had shoes on.
          </Box>
