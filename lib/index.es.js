...
var compose = function compose() {
  ...
  return function (p) {
    return css(_templateObject(), flattenBases.map(function (b) {
...
var boxSystem = system(_objectSpread$5({}, layoutConfig, {}, spaceConfig, {}, typographyConfig, {}, visualsConfig, {}, borderConfig, {}, flexConfig, {}, gridItemConfig, {}, positionConfig, {}, cursorConfig, {}, shadowConfig, {
  animation: true,
  transition: true,
  transform: true,
  filter: true,
...
var selectionBase = function selectionBase(p) {
  return css(_templateObject$1(), selectionSystem(p));
};
var boxBase = function boxBase(p) {
  return css(_templateObject2(), boxSystem(p), p._icon && css(_templateObject3(), pseudoBoxBaseComposed(_objectSpread$6({}, p._icon, {
    theme: p.theme
  })), system({
    fill: {
      property: 'fill',
    ...
    theme: p.theme
  }))), p._selection && css(_templateObject4(), selectionBase(_objectSpread$6({}, p._selection, {
    theme: p.theme
  }))), Object.keys(pseudoSelectors).map(function (k) {
    return p[k] && css(_templateObject5(), pseudoSelectors[k], pseudoBoxBaseComposed(_objectSpread$6({}, p[k], {
      theme: p.theme
    })));
  }), p._group && Object.keys(groupPseudoSelectors).map(function (k) {
    return p._group[k] && css(_templateObject6(), groupPseudoSelectors[k], pseudoBoxBaseComposed(_objectSpread$6({}, p._group[k], {
      theme: p.theme
    })));
  }));
};
...
var iconBase = base([flexBase], function (p) {
  return css(_templateObject10(), system({
    fill: {
      property: 'fill',
      scale: 'colors',
      transform: colorTransform
...
var Box = styled.div(_templateObject$2(), compose(boxBase));
...
var TextStyle = styled.span(_templateObject$3(), composedTextBase);
...
var Flex = styled.div(_templateObject$4(), composedFlexBase);
...
var AspectRatioStyle = styled.div(_templateObject$5(), composedBoxBase);
...
var IconStyle = styled.span(_templateObject$6(), composedIconBase);
...
var ImgStyle = styled.img(_templateObject$7(), composedBoxBase, system({
  objectFit: true
}));
...
var mediaQueries = function mediaQueries(breakpoints, predicate) {
  return breakpoints.map(function (br, i) {
    ...
    return isValueEmpty(val) ? css(_templateObject$8()) : i === 0 ? val : css(_templateObject2$1(), breakpoints[i - 1], val);
  });
};
...
var GridStyle = styled.div(_templateObject$9(), composedBoxBase, function (p) {
  return system(_objectSpread$8({}, gridConfig, {
    justifyItems: true,
    justifyContent: true,
    alignContent: true,
    alignItems: true,
...
var spin = keyframes(_templateObject$a());
var SpinnerStyle = styled.div(_templateObject2$3(), composedBoxBase, spin, function (_ref) {
...
var CellStyle = styled.div(_templateObject$b(), composedBoxBase, function (p) {
  ...
  mediaQueries(p.breakpoints, function (i) {
    ...
    (!column.empty(i) || !gap.empty(i)) && colStart && css(_templateObject2$4(), colStart), (!column.empty(i) || !gap.empty(i)) && colEnd && css(_templateObject3$2(), colEnd), (!row.empty(i) || !gap.empty(i)) && rowStart && css(_templateObject4$2(), rowStart), (!row.empty(i) || !gap.empty(i)) && rowEnd && css(_templateObject5$2(), rowEnd), // place-self
...
var ButtonStyle = styled.div(_templateObject$c(), compose(textBase, flexBase));
...
var TagStyle = styled.div(_templateObject$d(), compose(flexBase, textBase));
...
var CloseButtonStyle = styled.div(_templateObject$e(), composedFlexBase);
...
var LinkStyle = styled.a(_templateObject$f(), composedTextBase);
...
var ListStyle = styled.ul(_templateObject$g(), composedTextBase, function (p) {
  return system({
    paddingLeft: true,
    marginBottom: true,
    color: true,
...
var ListItemStyle = styled.li(_templateObject$h(), compose(flexBase, textBase));
...
var TypographyStyle = styled.p(_templateObject$i(), composedTextBase);
...
var ModalProvider = function ModalProvider(_ref) {
  ...
  }, children, modal && createElement(modal, {
...
var GlobalStyle = createGlobalStyle(_templateObject$j(), function (p) {
